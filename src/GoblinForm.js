    ...
    <div className='goblin-form-container quarter'>
      ...
      <form className='goblin-form' onSubmit={submitGoblin}>
        <label>
          ...
          <input required value={props.goblinFormName} onChange={e => props.submitGoblinFormName(e.target.value)}/>
        ...
        <label>
          ...
          <input required type="number" value={props.goblinFormHP} onChange={e =>props.submitGoblinFormHp(e.target.value)}/>
          {/* note that we're controlling the input's value from parent state */}
        </label>
        <label>
            Color
          {/* onChange, use the prop setGoblinFormColor to set the parent state */}
          <select required value={props.goblinFormColor} onChange={e => props.submitGoblinFormColor(e.target.value)}>
            {/* note that we're controlling the input's value from parent state */}
